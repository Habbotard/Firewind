...
namespace Butterfly.LicensingSystem
{
    sealed class License
    {
        ...
        {
            Logging.WriteLine("Encrypting: " + ÒÒÓÒ);
...
#if !DEBUG
            Logging.WriteLine("OMG ITS HERE");
        ...
        {
            Logging.WriteLine("Called method with [" + ÌÌÎÎ + "] and [" + ÁÄÁÃ + "]");
            try
            {
                ...
                Logging.WriteLine("Added credentials: [" + ÓÔÒÔ[(439 + -414)] + "] - [" +  ÓÔÒÔ[(-41 ^ -51)] + "]");
                col.Add(ÓÔÒÔ[(44 - 17)], ÌÌÌÍ(ÃÀÀÃ + ËÉÊÈ(ÔÔÒÓ) + ÁÄÁÃ + ÉÈÊË + ÌÌÎÎ));
                //Logging.WriteLine("Now going to send [" + ÁÂÅÃ + "] and these values : ");
                foreach(string s in col)
                {
                    Logging.WriteLine("========");
                    Logging.WriteLine(s +" - " + col[s]);
                    Logging.WriteLine("========");
                }
                //byte[] ÁÃÀÄ;
                ...
                //new Uri(ÁÂÅÃ);
                Logging.WriteLine("Created URI");
                Logging.WriteLine(WC.ToString());
                Logging.WriteLine("uploading...");
                Logging.WriteLine("values send");
