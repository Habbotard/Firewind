...
{
    public static class PhoenixDatabaseManager
    {
        ...
        public static void Initialize()
        {
            ...
            if (Application.GetConverter() == null)
            {
                Console.WriteLine("it's null.");
            }

            mMinPoolSize = Application.GetConverter().GetDatabaseConfig("phx").dbMinPool; //(int)ConfigManager.GetValue("mysql.pool.min")
            mMaxPoolSize = Application.GetConverter().GetDatabaseConfig("phx").dbMaxPool; //(int)ConfigManager.GetValue("mysql.pool.max")
            mPoolLifetime = Application.GetConverter().GetDatabaseConfig("phx").dbPoolLife; //(int)ConfigManager.GetValue("mysql.pool.lifetime")
        ...
        public static string GenerateConnectionString()
        {
            ...
            ConnectionStringBuilder.Server = Application.GetConverter().GetDatabaseConfig("phx").dbHost;
            ConnectionStringBuilder.Port = (uint)Application.GetConverter().GetDatabaseConfig("phx").dbPort;
            ConnectionStringBuilder.UserID = Application.GetConverter().GetDatabaseConfig("phx").dbUsername;
            ConnectionStringBuilder.Password = Application.GetConverter().GetDatabaseConfig("phx").dbPassword;
            ConnectionStringBuilder.Database = Application.GetConverter().GetDatabaseConfig("phx").dbDatabase;
            ConnectionStringBuilder.MinimumPoolSize = (uint)Application.GetConverter().GetDatabaseConfig("phx").dbMinPool;
            ConnectionStringBuilder.MaximumPoolSize = (uint)Application.GetConverter().GetDatabaseConfig("phx").dbMaxPool;
